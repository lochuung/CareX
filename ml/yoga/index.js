...
// for more details.
const generateContent = (data, fields) => {
...
(async () => {
  let binURL = await getGlobalDownloadURL(
    formatter("models", "group1-shard1of1", "bin")
  );
  let modelURL = await getGlobalDownloadURL(
    formatter("models", "model", "json")
  );
  let data = { binURL, modelURL };
