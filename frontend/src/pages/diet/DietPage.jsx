            ...
            <section >
                ...
                <div className='flex flex-row gap-3'>
                    <div className='left-side pt-8 text-sm font-semilbold space-y-6 w-3/6'>
                        ...
                        <Button value="large" block type='primary' onClick={() => navigate('/bmiresult')}>Tính ngay</Button>

                        <div className='pt-6'>
                          <p className='flex flex-row text-base font-semibold text-blue-500 items-center pb-2'><IoIosInformationCircleOutline style={{width: '40px', height: '20px'}}/>Miễn trừ trách nhiệm</p>
                          <p>Công cụ này chỉ mang tính chất tham khảo thông tin, không thay thế cho việc chẩn đoán hoặc điều trị y khoa. Hãy tham vấn thêm ý kiến bác sĩ bên cạnh việc tìm kiếm phương pháp điều trị trên trang HelloBacsi. Nếu bạn bị rối loạn ăn uống, kết quả tính chỉ số BMI sẽ không chính xác. Xin vui lòng liên hệ các chuyên gia y tế để được tư vấn thêm.</p>
                        </div>
                    </div>
                    <div className='right-side pl-10 w-3/6 pt-8'>
                        <div>
                            <p className='flex flex-row justify-center items-center text-base font-semibold text-blue-500'><IoIosInformationCircleOutline style={{width: '40px', height: '20px'}}/>Thông tin</p>
                            <div>
